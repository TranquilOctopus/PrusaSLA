...
- [ ] **M4.8c** Surface island issues to the user: after slicing, show a notification when `SLAResultData::issues` contains islands (count, worst layer) and make it open the layer once the inspector exists. Blocking export is out of scope here; the full marker UI is M5.8. · S · needs M4.8b
