...
using Slic3rLegacy::ConfigOptionFloat;
using Slic3rLegacy::ConfigOptionInt;
using Slic3rLegacy::ConfigOptionBool;
using Slic3rLegacy::ConfigOptionEnum;
using Slic3rLegacy::ForwardCompatibilitySubstitutionRule;
using Slic3rLegacy::SLADisplayOrientation;
using Slic3rLegacy::SLAMaterialSpeed;
