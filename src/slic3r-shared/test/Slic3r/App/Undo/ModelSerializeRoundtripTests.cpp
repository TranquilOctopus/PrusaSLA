...
TEST_CASE("ModelSerialize - roundtrip with SLA support points and drain holes", "[ModelSerialize][SLA][undo]")
{
    ...
    model_object->sla_support_points.push_back({Vec3f{10.0f, 20.0f, 5.0f}, 0.5f, 0.f, 0.f, 0.f, SupportPointType::manual_add});
    model_object->sla_support_points.push_back({Vec3f{15.0f, 25.0f, 6.0f}, 0.6f, 0.f, 0.f, 0.f, SupportPointType::island});
    model_object->sla_support_points.push_back({Vec3f{5.0f, 30.0f, 4.0f}, 0.4f, 0.f, 0.f, 0.f, SupportPointType::slope});
    // Point with per-point overrides
    model_object->sla_support_points.push_back({Vec3f{20.0f, 20.0f, 10.0f}, 1.2f, 1.8f, 3.5f, 1.2f, SupportPointType::manual_add});
...
TEST_CASE("ModelSerialize - roundtrip with multiple objects", "[ModelSerialize][SLA][undo]")
{
    ...
    obj1->sla_support_points.push_back({Vec3f{0.0f, 0.0f, 10.0f}, 0.3f, 0.f, 0.f, 0.f, SupportPointType::manual_add});
    ...
    obj3->sla_support_points.push_back({Vec3f{10.0f, 10.0f, 10.0f}, 0.4f, 0.f, 0.f, 0.f, SupportPointType::slope});
